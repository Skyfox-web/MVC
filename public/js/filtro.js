...
function filtros(tipo, valor, valor2, num){
    ...
    if(tipo != 6){
        ...
        for (i = 0; i < lista_filt_act.length; i++) {
			...
			}else if(lista_filt_act[i] != null && i == 8){
				list_activos += '<span onclick="filtros(8, '+valor+')"><i class="fa fa-times-circle" aria-hidden="true"></i>'+valor+'</span>'
			}
