		...
		<div class="col-xl-3 col-lg-4 col-md-4">
			<div class="Men-lat">
				...
				<div class="sub_cat_box" style="display:none;" id="tipo_colchon">
					<a  class="current"><li>Tamaño:<i class="fa fa-plus" id="showoff" aria-hidden="true"></i></li></a>
					<ul>
				...
				<!-- <div class="sub_cat_box" style="display:none;" id="tipo_genero">
					<a  class="current"><li>Genero:<i class="fa fa-plus" id="showoff" aria-hidden="true"></i></li></a>
					<ul>
						<div class="FiltroFC" id="">
				...
				<div class="sub_cat_box" style="display:none;" id="area_requerida_">
					<a  class="current"><li>Espacio disponible:<i class="fa fa-plus" id="showoff" aria-hidden="true"></i></li></a>
					<ul>
						<div class="FiltroFC">
						</div>
						<div class="input-group">
