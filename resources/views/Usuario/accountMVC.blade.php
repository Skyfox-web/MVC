...
<div class="container">
  <div class="row">
    <div class="col-md-12 col-lg-12 col-xl-12 Pag-cli">
      ...
      <ul class="nav nav-tabs nav-top nav-client-menu" id="myTab" role="tablist">
        <li class="nav-item">
        ...
        <li class="nav-item">
      	<a class="nav-link" id="contact-tab" data-toggle="tab" href="#Historial" role="tab" aria-controls="contact" aria-selected="false">Historial de compras</a>
        </li>

      </ul>

      <!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega-->
      <!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega-->
      <!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega--><!--Domicilios de entrega-->
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="Historial" role="tabpanel" aria-labelledby="contact-tab">
            <input type="hidden" id="orden_venta_histo" value="{{$isOrden}}">
            @if(!$isOrden)
            <div class="row">
...
<script>
    ...
    $(document).ready(function(){
        ...
        if($("#orden_venta_histo").val() == 'true' || $("#orden_venta_histo").val() == true){
            agregaHistorial();
        }
    ...
    function agregaHistorial(){
        ...
        for (var i = 0; i < historial.length; i++) {
            ...
            var datos_articulos = datos_orden['articulos'];
             ...
             // line-left-Open-C
            console.log(datos_orden["isCancelada"]);
            html_historial = '<div class="col-md-12">';
            if(datos_orden["isCancelada"] == 1){
                html_historial += '<div class="order-histo line-left-Open-C line-left-Closed" id="ord'+i+'" onclick="despHisto('+i+')">';
            }else{
                html_historial += '<div class="order-histo line-left-Closed" id="ord'+i+'" onclick="despHisto('+i+')">';
            }
            html_historial += '<div class="row">'
                        +'<div class="col-md-6">'
                            +'<div class="order-detail">'
                                +'<h5 class="title-detail-tlt">Orden de Venta</h5>';
                                if(datos_orden["folio_factura"] == null){
                                    html_historial += '<h6 class="subtitle-detail-tlt">Cancelado</h6>';
                                }else{
                                    html_historial += '<h6 class="subtitle-detail-tlt">FW - ' + datos_orden["folio_factura"] + '</h6>';
                                }
                ...
                +'</div>';
                if(datos_orden["isCancelada"] == 1){
                    html_historial += '<div class="Detalles-Compra line-left-Open-C line-left-Closed" id="det'+i+'">';
                }else{
                    html_historial += '<div class="Detalles-Compra line-left-Closed" id="det'+i+'">';
                }
                html_historial += '<div class="row justify-content-md-center">'
                        +'<div class="col-md-12">'
